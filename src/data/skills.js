export const skills = {
  ...
  'Bless Boost': {
    ...
    element: 'passive',
    personas: {Daisoujou: 42, Mithra: 37, Power: 44, Principality: 34},
  },
  Bloodbath: {
    cost: 19,
  ...
  'Dodge Psy': {
    ...
    element: 'passive',
    personas: {'Kin-Ki': 28, 'Koh-i-Noor': 0},
  },
  'Dodge Wind': {
  ...
  'Apocalyptic Fury': {
    effect: 'Strengthens Phys attacks by 30%',
    element: 'trait',
  },
  'Ave Maria': {
  ...
  Avenger: {
    ...
    element: 'trait',
    personas: {'Hope Diamond': 0},
  },
  'Blade of Rebellion': {
    cost: 9900,
    effect:
      'Deal severe Almighty damage to 1 for with extra effectiveness if down.',
    element: 'almighty',
    unique: 'Hereward',
  },
  'Bless Lineage': {
  ...
  'Brave Step': {
    cost: 1600,
    effect: 'Increase critical rate for all allies.',
    element: 'support',
    unique: 'Cendrillon',
  },
  'Burning Touch': {
  ...
  'Charge All': {
    cost: 8000,
    effect: "Multiply all allies' next Phys attack damage by 2.5.",
    element: 'support',
    unique: 'William',
  },
  'Charging Bull': {
    effect: 'Scales damage dealt against lost HP',
    element: 'trait',
    unique: 'Asterius',
  },
  Checkmate: {
    cost: 9000,
    effect: "Decrease all foes' Attack, Defense and Agility for 3 turns.",
    element: 'support',
    unique: 'Agnes',
  },
  Cocytus: {effect: 'Reduces costs of Ice skills by 75%', element: 'trait'},
  'Concentrate All': {
    cost: 8000,
    effect: "Multiply all allies' next Magic attack damage by 2.5.",
    element: 'support',
    unique: 'Celestine',
  },
  Coolheadedness: {
  ...
  'Creation Ceremony': {
    effect:
      'Scales damage dealt and received against Compendium completion rate. Can exceed 100% limit',
    element: 'trait',
  ...
  'Cunning Strategist': {
    effect: 'Halves Support and Almighty skill costs for all allies',
    element: 'trait',
    unique: 'Hereward',
  },
  'Cunning Tactician': {
    effect: 'Halves Support skill costs for all allies',
    element: 'trait',
    unique: 'Robin Hood',
  },
  'Curse Lineage': {
  ...
  'Divine Ceremony': {
    effect: 'Raises chance of ally traits activating',
    element: 'trait',
    unique: 'Izanagi',
  },
  'Double Shot': {
  ...
  Enlightenment: {
    effect: 'Extends buffs cast on self by 2 turns',
    element: 'trait',
  },
  'Exquisite Technique': {
    effect: 'Strengthens technical damage by 25%',
    element: 'trait',
    personas: {Regent: 0},
  },
  'False Painting': {
  ...
  'Five Elements': {
    effect: 'Strengthens technical damage by 50%',
    element: 'trait',
  },
  'Focused Gaze': {
    effect: 'Strengthens single-target magic by 20%. Can exceed 100% limit',
    element: 'trait',
    personas: {'Stone of Scone': 0},
  },
  'Forbidden Knowledge': {
    effect: 'Reduces costs of magic attack skills by 75%',
    element: 'trait',
  },
  'Foul Contagion': {
  ...
  'Freezing Follow-up': {
    effect: 'Increases chance of inflicting Freeze on downed foe',
    element: 'trait',
  },
  'Furious Spirit': {
  ...
  'Group Hypnosis': {
    effect: 'Extends buffs cast on allies by 1 turn',
    element: 'trait',
  ...
  Heavyweight: {
    effect: 'Strengthens Phys skills by 20%',
    element: 'trait',
    personas: {'Hope Diamond': 0},
  },
  "Herald's Grace": {
  ...
  'Heretic Charisma': {
    effect: 'Strengthens magic skills by 50%',
    element: 'trait',
  },
  'Hidden Presence': {
    effect: 'Increased chance of ally follow-up attacks',
    element: 'trait',
    unique: 'Raoul',
  },
  'High-speed Hacking': {
  ...
  'Hollow Fool': {
    effect:
      'Raises damage dealt by 40% for each foe afflicted with an ailment. Can exceed 100% limit',
    element: 'trait',
    unique: 'Magatsu-Izanagi',
  },
  'Hunting Premonition': {
  ...
  'Life Focus': {
    effect: 'Strengthens HP regeneration skills by 50%',
    element: 'trait',
    personas: {'Stone of Scone': 0},
  },
  'Life Wall': {
  ...
  'Lotus Dance': {
    effect: 'Extends buffs cast on allies by 2 turns',
    element: 'trait',
  },
  'Majestic Aura': {
    effect:
  ...
  Masquerade: {
    cost: 25,
    effect: 'Deal 2 times severe Phys damage to 1 foe.',
    element: 'phys',
    unique: 'Ella',
  },
  ...
  'Myriad Blooms': {
    cost: 9000,
    effect: "Increase all allies' Attack, Defense and Agility for 3 turns.",
    element: 'support',
    unique: 'Gorokichi',
  },
  'Myriad Truths': {
  ...
  'Offered Soul': {
    effect: 'Doubles effectiveness of HP and SP regeneration skills',
    element: 'trait',
    unique: 'Messiah',
  },
  'Olive Grace': {
    effect: 'Halves costs of skills after Baton Pass',
    element: 'trait',
    unique: 'Athena',
  },
  'Oni Whisper': {
    effect: 'Doubles effectiveness of HP regeneration skills',
    element: 'trait',
  },
  'Pandemic Gaze': {
    effect: 'Raises damage dealt by 25% for each foe afflicted with an ailment',
    element: 'trait',
    personas: {'Crystal Skull': 0},
  },
  'Path of Carnage': {
  ...
  'Peerless Gaze': {
    effect: 'Strengthens all-target magic by 20%. Can exceed 100% limit',
    element: 'trait',
    personas: {Regent: 0},
  },
  'Phantom Show': {
  ...
  Relentlessness: {
    effect: 'Strengthens attacks that strike foe weaknesses by 50%',
    element: 'trait',
    personas: {'Stone of Scone': 0},
  },
  'Roguish Instinct': {
    effect: 'Chance to evade Phys attacks for all allies',
    element: 'trait',
    unique: 'Goemon',
  },
  'Saintly Devotion': {
  ...
  'Self Hypnosis': {
    effect: 'Extends buffs cast on self by 1 turn',
    element: 'trait',
    personas: {'Hope Diamond': 0},
  },
  'Shocking Follow-up': {
  ...
  'Spirit Focus': {
    effect: 'Strengthens SP regeneration skills by 50%',
    element: 'trait',
    personas: {Orichalcum: 0},
  },
  'Stagnant Aura': {
  ...
  'Sword God': {effect: 'Triples damage from Charge skills', element: 'trait'},
  'Treasured Talent': {
  ...
  'Tree of Life': {
    effect: 'Strengthens damage dealt on downed foes by 50%',
    element: 'trait',
    unique: 'Tsukiyomi',
  },
  'Ultimate Support': {
    effect: 'Moral Support may activate simultaneous effects',
    element: 'passive',
    unique: 'Al Azif',
  },
  'Unstoppable Hacking': {
